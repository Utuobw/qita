...
if [ $OSNAME != "macos" ];then
	...
	# https://raw.githubusercontent.com/Utuobw/qita/main/install.sh
	if [ ! -d /www/server/mdserver-web ];then
		if [ "$LOCAL_ADDR" == "common" ];then
			curl --insecure -sSLo /tmp/master.zip ${HTTP_PREFIX}raw.githubusercontent.com/Utuobw/qita/refs/heads/main/mdserver-web-master.zip
			cd /tmp && unzip /tmp/master.zip
			mv -f /tmp/mdserver-web-master /www/server/mdserver-web
			rm -rf /tmp/master.zip
			rm -rf /tmp/mdserver-web-master
		else
			# curl --insecure -sSLo /tmp/master.zip https://raw.githubusercontent.com/Utuobw/qita/refs/heads/main/mdserver-web-master.zip
			wget --no-check-certificate -O /tmp/master.zip https://raw.githubusercontent.com/Utuobw/qita/refs/heads/main/mdserver-web-master.zip
			cd /tmp && unzip /tmp/master.zip
	...
	if [ ! -d /root/.acme.sh ];then
	    if [ "$LOCAL_ADDR" != "common" ];then
	        curl --insecure -sSLo /tmp/acme.tar.gz https://raw.githubusercontent.com/Utuobw/qita/refs/heads/main/acme.sh-master.tar.gz
...
if [ "${OSNAME}" == "macos" ];then
	curl --insecure -fsSL https://raw.githubusercontent.com/Utuobw/qita/main/macos.sh | bash
else
